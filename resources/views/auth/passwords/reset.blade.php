                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row my-5 mx-3">
                            <div class="col-lg-6 d-none d-lg-block"
                                style="background-image:url('/dist/img/forgot-password.jpg'); background-size: cover;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST"  action="{{ route('password.update') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="Enter Email Address..." aria-describedby="emailHelp" >
