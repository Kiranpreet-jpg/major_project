...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <body>
                        ...
                        <div class="col-md-6 hearder-right-agile">
                            <div class="d-flex">
                                ...
                                <div class="login-wthree my-auto">
                                    @if (Auth::guest())
                                        <a href="{{ route('web.home') }}" class="text-white text-capitalize">login<span
                                                class="fas fa-sign-in-alt flash animated infinite"></span></a>
                                    @else
                                        <span class="text-light">{{ Auth::user()->name }}</span>
                                        <a href="{{ route('web.logout') }}"
                                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                            data-toggle="modal" data-target="#logoutModal"
                                            class="text-white text-capitalize">Logout<span
                                                class="fas fa-sign-in-alt flash animated infinite"></span></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav text-center ml-auto">
                                ...
                                <li class="nav-item mr-lg-3 my-lg-0 my-4">
                                    <a class=" hover-fill" data-txthover="Assignment/Exam"
                                        href="{{ route('stuAssignment.index') }}" id="navbarDropdown" role="button">
                                        Assignment/Exam
                                    </a>
                                </li>
                                <li class="nav-item mr-lg-3 my-lg-0 my-4">
                                    <a class=" hover-fill" data-txthover="Notes" href="{{ route('stuNotes.index') }}"
                                        id="navbarDropdown" role="button">
                                        Notes
                                    </a>
                                </li>
                                <li class="nav-item mr-lg-3 my-lg-0 my-4">
                                    <a class="hover-fill" href="{{ route('web.viewAttendance') }}"
                                        data-txthover="Attendance">Attendance</a>
                                </li>
                                <li class="nav-item">
                                    <a class="hover-fill" href="{{ route('feedbacks.create') }}" data-txthover="Feedback">Feedback</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
        ...
        <div class="inner-banner-w3ls text-right d-flex align-items-center">
            <div class="container">
                <h6 class="agileinfo-title">{{ $student_detail->name }}</h6>
                <ol class="breadcrumb-parent d-flex justify-content-end">
                    <li class="breadcrumb-nav">
                        <a href="#">{{ $student_detail->course->name }}</a>
                    </li>
                    <li class="breadcrumb-nav active  text-capitalize" aria-current="page">{{ $student_detail->roll_number }}</li>
                </ol>
            </div>
        </div>
        <!-- //banner -->
